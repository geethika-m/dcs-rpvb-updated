...
const ResetPasswordForm = ({ actionCode }) => {
  ...
  const handleReset = async () => {
    ...
    verifyPasswordResetCode(auth, actionCode).then(async (email) => {
      ...
      if (checkMsg.includes("SUCCESS")) {
        ...
        const usersSnapShot = await database.usersRef
          .where("email", "==", email)
          .get();
      ...
      <Form className="Login-form">
        <div className="Login-form-content">
          ...
          <Form.Group id="newPwd">
            ...
            />
            {errors.newPassword && (
              <p className="validate-error">{errors.newPassword} </p>
            )}
          </Form.Group>
          <Form.Group id="cfmPassword">
            ...
            />
            {errors.cfmPassword && (
              <p className="validate-error">{errors.cfmPassword}</p>
            )}
          </Form.Group>
          <div
            className={`message ${
