      ...
      <div className="CreateUser-form-container">
        <Form className="CreateUser-form">
          <div className="CreateUser-form-content CreateUser-child1 ">
            <h3>
              <div>
                <AiIcons.AiOutlineUserAdd size={30} color="black" />
              </div>
              Create User
            </h3>
            ...
            <Form.Group id="fullName">
              <Form.Label className="CreateUser-label">Name:</Form.Label>
              <br />
              <Form.Control
            ...
            <Form.Group id="email">
              <Form.Label className="CreateUser-label">Email:</Form.Label>
              <br />
              <Form.Control
                className="CreateUser-input-style"
                title={"email"}
            ...
            <Form.Group id="password">
              <Form.Label className="CreateUser-label">Password:</Form.Label>
              <br />
              <Form.Control
                className="CreateUser-input-style"
                name={"password"}
          ...
          <div className="CreateUser-form-content2 CreateUser-child2">
            <Form.Group id="department">
              <Form.Label className="CreateUser-label">Department</Form.Label>
              <br />
              <Form.Select
                className="input-ddl-style"
                title={"department"}
                name={"department"}
                id={"department"}
                onChange={handleChange}
              ...
              >
                ...
                <option value={"Admin and Quality Service"}>
                  Admin and Quality Service
                </option>
                <option value={"Centre Management"}>Centre Management</option>
                <option value={"Corporate Development and Human Resource"}>
                  CDHR
                </option>
                <option value={"Curatorial & Collections"}>
                ...
                <option value={"Exhibition & Volunteers Management"}>
                  Exhibition & Volunteers Management
                </option>
                <option value={"Finance & Procurement"}>
                  Finance & Procurement
                </option>
                <option value={"Group Programmes"}>Group Programmes</option>
                <option value={"Infrastructure & Sustainability"}>
                ...
                <option value={"Singapore Discovery Centre"}>
              ...
              {errors.department && (
                <p className="validate-error">{errors.department}</p>
              )}
            </Form.Group>
            <Form.Group id="userType">
              <Form.Label className="CreateUser-label">User Type</Form.Label>
              <br />
              <Form.Select
                className="input-ddl-style"
                title={"userType"}
              ...
              {errors.userType && (
                <p className="validate-error">{errors.userType}</p>
              )}
            </Form.Group>
          </div>
        </Form>
