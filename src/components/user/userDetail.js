...
const UserDetail = (props) => {
  ...
  const fullNameRef = useRef(userData.fullName);
  const emailRef = useRef(userData.email);
  const mobileNumberRef = useRef(userData.mobileNumber);
          ...
          <div className="ViewUser-form">
            <div className="ViewUser-form-content ViewUser-child1">
              <h3 className="ViewUser-title login-icon">
                <div>
                  <BiIcons.BiSolidUserDetail size={30} color="black" />
                </div>
                User Profile
              </h3>
              <Form onSubmit={handleSubmit}>
                <Form.Group as={Row} id="museum">
                  <Form.Label className="ViewUser_label">Museum:</Form.Label>
                  <br />
                  <Col>
                    <Form.Control
                      className="ViewUser-input-style"
                ...
                <Form.Group as={Row} id="fullName">
                  <Form.Label className="ViewUser_label">Name:</Form.Label>
                  <br />
                  <Col>
                    <Form.Control
                      className="ViewUser-input-style"
                ...
                <Form.Group as={Row} id="email">
                  <Form.Label className="ViewUser_label">Email:</Form.Label>
                  <br />
                  <Col>
                    <Form.Control
                      className="ViewUser-input-style"
                ...
                <Form.Group as={Row} id="mobileNumber">
                  <Form.Label className="ViewUser_label">
                    Mobile Number:
                  </Form.Label>
                  <br />
                  <Col>
                ...
                <Form.Group as={Row} id="userType">
                  <Form.Label className="ViewUser_label">User Type:</Form.Label>
                  <br />
                  <Col>
                    <Form.Control
                      className="ViewUser-input-style"
                ...
                <Form.Group as={Row} id="status">
                  <Form.Label className="ViewUser_label">Status:</Form.Label>
                  <br />
                  <Col>
                    <Form.Select
                      className="ViewUser-ddl-style"
                      ref={statusRef}
                      disabled={formState}
                      readOnly={archived}
                ...
                {archive && (
                  <Alert className="archivedAlert" variant="info">
                    Account is archived, no editing is available.
                  </Alert>
                )}
              </Form>
            </div>
            <div className="ViewUser-form-content2 ViewUser-child2">
              <h3 className="ViewUser-title login-icon">
                <div>
                  <HiIcons.HiInformationCircle size={30} color="black" />
                </div>
                User Logging
              </h3>
              <Form.Group as={Row} id="createdOn">
                ...
                <br />
                <div className="ViewUser-data-style">
                  {convertEpoch(userData.createdOn)}
                </div>
              </Form.Group>
              <Form.Group as={Row} id="lastLogin">
                ...
                <div className="ViewUser-data-style">
                  {userData.lastActive
                    ? convertEpoch(userData.lastActive)
                    : "User has not login before"}
                </div>
              </Form.Group>
              <Form.Group as={Row} id="passwordChange">
                ...
                <br />
                <div className="ViewUser-data-style">
                  {userData.lastChangedPassword
                    ? convertEpoch(userData.lastChangedPassword)
                    : "User have no record of changing password"}
                </div>
              </Form.Group>
              {userData.archivedDate && (
                <Form.Group as={Row} id="arhivedDate">
                  ...
                  <br />
                  <div className="ViewUser-data-style">
                    {convertEpoch(userData.archivedDate)}
                  </div>
                </Form.Group>
              )}
            </div>
