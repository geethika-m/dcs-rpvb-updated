...
`;
    ...
    const handleCustomisedSetupUpload = async (e) => {
        ...
        const file = e.target.files[0];
          const customLayoutRef = ref(storage, `customlayouts/${recordData.bkId}/${file.name}`);
                ...
                <Form className="ViewBooking-form" onSubmit={handleSubmit}>
                    <div className="ViewBooking-form-content ViewBooking-child1 ">
                        ...
                        <Form.Group id="programmes" >
                            <Form.Label className="ViewBooking-label">Programme Name:</Form.Label><br/>
                            <Form.Control className="ViewBooking-input-style"
                        ...
                        <Form.Group id="nofPax" >
                            <Form.Label className="ViewBooking-label">No Of Pax:</Form.Label><br/>
                                <Form.Control
                        ...
                        <Form.Group id="organisation" >
                            <Form.Label className="ViewBooking-label">Organisation:</Form.Label><br/>
                            <Form.Control className="ViewBooking-input-style"
                        ...
                        {userType === "Approver" && recordData.approvalStatus !== "Cancelled" && !formState ? (
                    ...
                    ) : (userType === "Approver" && recordData.approvalStatus !== "Cancelled" && (
                        <Button
                    ...
                    <div className="information">
                        <p><strong>BookID:</strong><br/> {recordData.bkId}</p>
                        <p><strong>Requestor Name:</strong><br/> {recordData.requestorName}</p>
                    </div>
                       {/* Tempoary hidden */}
                      {/*   {formState ? (
                        ...
                        <Form.Group id="selectedDate" >
                                ...
                                <Form.Control className="ViewBooking-input-style"
                                    placeholder={format(new Date(recordData.selectedDate), 'dd-MMM-yyyy')}
                                    type={"text"}
                                    disabled
                                    readOnly
                                />
                        ...
                        <Form.Group id="timeslot" >
                                <Form.Label className="ViewBooking-label">Timeslot:</Form.Label><br/>
                                <Form.Control className="ViewBooking-input-style"
                                    placeholder={recordData.timeSlot}
                                    type={"text"}
                                    disabled
                                    readOnly
                                />
                        ...
                        <Form.Group id="setup">
                        <Form.Label className="ViewBooking-label">Setup:</Form.Label><br />
                        {!formState ? (
                            <Form.Select
                                className="viewBooking-ddl-style2"
                                disabled={formState}
                                defaultValue={recordData.setup}
                                type={"text"}
                            ...
                            recordData.setup === "Other" ? (
                                <div className="ViewBooking-input-style">
                                    <a href={recordData.customiseSetup} download>Download Setup</a>
                                </div>
                            ) : (
                                <Form.Control
                                    className="ViewBooking-input-style"
                        ...
                        <Form.Group id="customisedSetup">
                            <Form.Label className="ViewBooking-label">Please upload custom layout:</Form.Label><br/>
                            <Form.Control
                        ...
                        <div className='btn-flex'>
                            {userType === "Approver" && recordData.approvalStatus === "Pending" && formState &&
                            (
                             <Button 
                    ...
                    <div className="information">
                        <p><strong>Date Created:</strong> <br/>{recordData.dateCreated}</p>
                        {(recordData.approvalStatus === "Approved" || recordData.approvalStatus === "Cancelled") && (
                        <p><strong>Approver:</strong> <br/>{recordData.approverName}</p>
                        )}
                    </div>      
                        {recordData.bookStatus !== "Cancelled" && (
                        <Form.Group id="approvalStatus" >
                                <Form.Label className="ViewBooking-label">Approval Status:</Form.Label><br/>
                                <Form.Control className="ViewBooking-input-style"
                        ...
                        <Form.Group id="bookStatus" >
                                <Form.Label className="ViewBooking-label">Booking Status:</Form.Label><br/>
                                <Form.Control className="ViewBooking-input-style"
                        ...
                        <Form.Group id="completedDate" >
                                <Form.Label className="ViewBooking-label">Completed Date:</Form.Label><br/>
                        ...
                        <Form.Group id="remarks">
                            <Form.Label className="ViewBooking-label">Remarks:</Form.Label><br/>
                            <Form.Control className='View-input-style2'
                                as="textarea"
                                rows={6}
                        ...
                        {recordData.userId === currentUser.uid && recordData.approvalStatus !== "Cancelled" && formState &&
                            (
                            <Button
                                className={"ViewBooking-Cancel-button"}
