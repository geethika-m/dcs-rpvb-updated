...
/**
 * @function CreateBookingApproverForm
 *
...
const CreateBookingApproverForm = () => {    
    /* 
    ...
    */
    ...
    const checkAvailability = async () => {
        ...
        */
        ...
        const endDateTime = new Date(`${values.selectedDate} ${endTime}`);
        ...
        const bookedEndDateTime = new Date(`${values.selectedDate} ${endBookedTime}`);
    ...
    */
    const handleBookingRequest = async () => {
        ...
        if(isAvailable) {
            try {     
                const requestorName = values.requestorName || fullName;
            ...
            */
            ...
            if (values.requestorName === fullName){
...
`;
                const response2 = await axios.post('https://us-central1-rpvb-web.cloudfunctions.net/sendEmail', {
                    ...
                    subject: `Venue Booking ID${newBKID} is Created`,
...
`;
                ...
                // Send email to EMP Dept about the new booking request
                const customMessage2 = 
`Dear EMP,

A new venue booking ${newBKID} has been created by ${fullName}. 

Requestor Name: ${values.requestorName}
Event: ${values.eventName}
Organisation: ${values.organisation}
Date of Event: ${values.selectedDate}
Timeslot: ${combinedTimeSlot}
    ...
    return (
        ...
        <Form className="CreateBooking-form">
            <div className="CreateBooking-form-content CreateBooking-child1 ">
                ...
                {userType === "Approver" && (
                <Form.Group id="requestorName">
                <Form.Label className="CreateUser-label">Requestor Name:</Form.Label><br/>
                <Form.Control
                  className="CreateUser-input-style"
                  title={"requestorName"}
                  name={"requestorName"}
                  type={"text"}
                  value={values.requestorName ? values.requestorName : fullName}
                  minLength={"2"}
                  maxLength={"256"}
                  onChange={handleChange}
                />
                {errors.requestorName && ( <p className="validate-error">{errors.requestorName} </p> )}
                </Form.Group>
                )}
            ...
            <div className="CreateBooking-form-content2 CreateBooking-child2"> 
                <Form.Group id="location">
                    <Form.Label className="CreateUser-label">Location:</Form.Label><br/>
                ...
                <Form.Group id="selectedDate">
                    <Form.Label className="CreateUser-label">Date:</Form.Label><br/>
...
export default CreateBookingApproverForm;